...
export const swaggerSpec = {
    ...
    paths: {
        ...
        '/api/v1/interviews': {
            get: {
                tags: ['Interview'],
                summary: 'Retrieve a list of all interviews',
                security: [{ bearerAuth: [] }],
                responses: {
                    '200': {
                        description: 'A list of interviews.',
                        content: { 'application/json': { schema: { type: 'array', items: { $ref: '#/components/schemas/Interview' } } } },
                    },
                },
            },
            post: {
                ...
                requestBody: {
                    required: true,
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateInterview' } } },
                },
                responses: { '201': { description: 'Interview created successfully.' } },
            },
        },
        '/api/v1/interviews/{id}': {
            ...
            patch: {
                ...
                requestBody: {
                    required: true,
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateInterview' } } },
                },
                responses: { '200': { description: 'Interview updated successfully.' } },
            },
            delete: {
                tags: ['Interview'],
                ...
                security: [{ bearerAuth: [] }],
                parameters: [{ in: 'path', name: 'id', required: true, schema: { type: 'string' } }],
                responses: { '204': { description: 'Interview deleted successfully.' } },
            },
        },
            ...
            get: {
                ...
                responses: {
                    '200': {
                        ...
                        content: { 'application/json': { schema: { type: 'array', items: { $ref: '#/components/schemas/InterviewComment' } } } },
                    },
                },
            },
            post: {
                ...
                requestBody: {
                    required: true,
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/CreateInterviewComment' } } },
                },
        ...
        '/api/v1/interviews/{interviewId}/comments/{commentId}': {
            patch: {
                ...
                security: [{ bearerAuth: [] }],
                parameters: [
                    { in: 'path', name: 'interviewId', required: true, schema: { type: 'string' } },
                    { in: 'path', name: 'commentId', required: true, schema: { type: 'string' } },
                ],
                requestBody: {
                    required: true,
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateInterviewComment' } } },
                },
        ...
        '/api/v1/interviews/{interviewId}/history': {
            get: {
        ...
        '/api/v1/users/{id}/roles': {
            patch: {
                ...
                requestBody: {
                    required: true,
                    content: { 'application/json': { schema: { $ref: '#/components/schemas/UpdateUserRoles' } } },
                },
                responses: { '200': { description: 'User roles updated successfully.' } },
            },
        },
    },
    components: {
